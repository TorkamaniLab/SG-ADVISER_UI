...
public class CnvStatistics implements Runnable
{
	...
	private void ADVISER_genotype(String[] spLine)
	{
		if (spLine[getHeaderIndex("ADVISER_Score_Clinical")].contains("1~"))
		{
			...
			for (int ij = 0; ij < spValue.length; ij++)
			{
						...
						|| spValue[ij].equals("1|1"))
				{
					...
					int tempValue = Integer.parseInt(ADVISER1_genotype.get(ij));
					tempValue++;
	...
	private void writeToFile() throws IOException
	{
		...
		if (TFBS_rear_tot != 0)
		{
			...
			// System.out.println("Rate rearrangements is:" + c);
	...
	private boolean Protein_Domains_Impact(String[] spLine)
	{
		...
		for (int i = 0; i < entry.length; i++)
		{
			if (entry[i].equals("-"))
			{
				System.out.println("entry.length is: " + entry.length);
				continue;
			} else
			{
